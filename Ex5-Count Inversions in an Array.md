...
Use merge sort to split the array into halves.
Count inversions in the left half and right half.
Merge the halves and count cross-inversions when right element < left element.
Add all inversion counts and print the result.
## Program:
```
/*
...
## Output:
<img width="478" height="337" alt="image" src="https://github.com/user-attachments/assets/7106c388-6501-4d52-bdfe-0790ba3d9b06" />
